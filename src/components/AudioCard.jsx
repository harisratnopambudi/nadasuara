...
export default function AudioCard({ item, onDelete }) {
  ...
  return (
    <div className="bg-slate-900 border border-slate-700 rounded-xl p-4 hover:border-indigo-500/50 hover:shadow-md hover:shadow-indigo-500/5 transition-all group">
      ...
      <p className="text-sm text-slate-300 mb-4 line-clamp-2 leading-relaxed italic opacity-90 border-l-2 border-slate-700 pl-2">
        "{item.text}"
      </p>
